...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post relationships_url, params: { relationship: { a: @relationship.a, b: @relationship.b, score: @relationship.score } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { a: @relationship.a, b: @relationship.b, score: @relationship.score } }
